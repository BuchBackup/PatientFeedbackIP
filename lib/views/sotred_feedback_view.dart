                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Text(
                                storedFCon.storedFeedbackModel?.patientName ??
                                    'N/A',
                                style: kBodyWhite12,
                              ),
                            ],
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                storedFCon.storedFeedbackModel?.doctorName ??
                                    'N/A',
                                style: kBodyWhite12,
                              ),
                            ],
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                storedFCon.storedFeedbackModel?.gender ?? 'N/A',
                                style: kBodyWhite12,
                              ),
                            ],
                          ),
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                '${entry.value}%',
                                style:
                                    TextStyle(fontSize: 12, color: valueColor),
                                textAlign: TextAlign.center,
                              ),
                            ),
                            Padding(
                              ...
                              child: Text(
                                emoji,
                                style:
                                    TextStyle(fontSize: 18, color: valueColor),
                                textAlign: TextAlign.center,
                              ),
                            ),
                          ],
